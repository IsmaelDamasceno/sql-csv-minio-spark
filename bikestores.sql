-- BikeStores — DDL + DML
-- Gerado automaticamente a partir dos CSVs em raw/
...
-- Foreign Keys
ALTER TABLE staffs    ADD CONSTRAINT fk_staffs_store    FOREIGN KEY (store_id)    REFERENCES stores(store_id);
...
ALTER TABLE products  ADD CONSTRAINT fk_products_cat    FOREIGN KEY (category_id) REFERENCES categories(category_id);
...
ALTER TABLE orders    ADD CONSTRAINT fk_orders_staff    FOREIGN KEY (staff_id)    REFERENCES staffs(staff_id);
